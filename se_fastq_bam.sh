...
# Jason Grundstad
# 05/08/2014
# Pass raw single-end fastq data files through picard to convert output to single, unaligned BAM
# 
...
java -Xmx2g -jar $PICARD_DIR/FastqToSam.jar TMP_DIR=$PICARD_TEMP FASTQ=$FQC1 FASTQ2=$FQC2 OUTPUT=$FINAL_BAM \
	...
	SORT_ORDER=unsorted VALIDATION_STRINGENCY=LENIENT VERBOSITY=DEBUG > $SAMPLE.clip.convert.log 2>&1
