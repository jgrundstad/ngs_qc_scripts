...
ls *_[1-8]_1_sequence.txt.gz | cut -f1-6 -d "_" | parallel -P 28 /lustre/beagle/jgrundst/src/ngs_qc_scripts/fastq_to_bam.sh -1 {}_1_sequence.txt.gz -2 {}_2_sequence.txt.gz
